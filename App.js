  ...
  return (
    <View style={{flex: 1, flexDirection: 'row', width: 75}}>
      ...
      <TouchableOpacity
        ...
        <View style={styles.count_cart}>
          <Text style={styles.count_cart_total}>8</Text>
        </View>
        <Icon
          style={styles.hedericon}
          size={20}
  ...
  return (
    <View style={{flex: 1, flexDirection: 'row', width: 75}}>
      <TouchableOpacity
        ...
        <View style={styles.count_cart_new}>
          <Text style={styles.count_cart_total}>8</Text>
        </View>
        <Icon
          style={styles.hedericon}
  ...
  return (
    <View style={{flex: 1, flexDirection: 'row', width: 150}}>
      ...
      <TouchableOpacity
        ...
        <Image
          source={{
            uri: 'https://blgindia.com/blghr/images/chrome-capture.png',
          }}
        ...
        options={{
          ...
          tabBarButton: props => (
            <TouchableOpacity
              {...props}
              onPress={() => {
                Linking.openURL('tel:7726988292');
              }}
            />
          ),
        }}
